...
void PopFileInitialize (HWND hwnd)
	 ...
	 static TCHAR szFilterImg[] = 
	                          TEXT("Image Files (*.bmp;*.jpg;*.gif;*.png;*.tif;*.ico;*.emf;*.wmf)\0*.bmp;*.jpg;*.gif;*.png;*.tif;*.ico;*.emf;*.wmf\0")  \
                              TEXT("All Files (*.*)\0*.*\0\0") ;
...
BOOL PopFileOpenDlgImg (HWND hwnd, PTSTR pstrFileName, PTSTR pstrTitleName)
     {
